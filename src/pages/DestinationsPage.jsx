...
const destinationCards = [
  {
    ...
    tag: "Heritage & Royal",
    description:
      "Experience the royalty of Jaipur, Jodhpur, and Udaipur in a grand 7-day tour.",
    duration: "7D/6N",
    image:
      "https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&q=80&w=1400",
...
const trustItems = [
  {
    ...
    body: "Lowest prices with zero hidden charges.",
    icon: CircleDollarSign,
  },
  {
    title: "Customized Packages",
    body: "Itineraries tailored to your preferences.",
    icon: PencilRuler,
  },
  {
    title: "24/7 Support",
    body: "Dedicated concierge for your entire trip.",
    icon: Headphones,
  },
  {
    title: "Verified Partners",
    body: "Top-tier hotels and transport services.",
    icon: ShieldCheck,
  },
];
...
export function DestinationsPage() {
  return (
    <>
      <Seo
        title="Tour Packages | GK Immigrations"
        description="Explore domestic and international tour packages with GK Immigrations."
      />
        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-body-lg text-blue-50/90">
              Handpicked domestic and international trips at the best prices,
          ...
          <Reveal delay={120} className="mx-auto mt-12 max-w-4xl">
            <div className="glass-panel package-search-shadow rounded-xl border border-white/20 p-2 text-on-surface md:rounded-full">
              <div className="flex flex-col items-center gap-2 md:flex-row">
                ...
                <Link
                  to="/contact"
                  className="cta-button w-full rounded-full px-8 py-4 md:w-auto"
                >
                  Plan My Trip
                </Link>
              </div>
        ...
        <div className="container-shell">
          <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <Reveal delay={80}>
              <div className="flex rounded-full border border-outline-variant bg-surface-container p-1">
                <button className="rounded-full px-6 py-2 text-sm font-semibold text-on-surface-variant transition hover:bg-white/60">
                  International
                </button>
                <button className="rounded-full bg-primary px-6 py-2 text-sm font-semibold text-white shadow-soft">
                  Domestic
                </button>
              </div>
            </Reveal>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {destinationCards.map((destination, index) => (
              ...
              >
                <article
                  className={`bento-animated group relative overflow-hidden rounded-2xl bg-primary text-white ${destination.featured ? "min-h-[450px]" : "min-h-[400px] lg:min-h-[450px]"}`}
                >
                  <img
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
                    <p className="mb-1 text-xs font-bold uppercase tracking-wider text-secondary-container sm:text-sm">
                      {destination.tag}
                    </p>
                    <h3
                      className={`font-heading font-bold ${destination.featured ? "text-display-xl" : "text-headline-lg"}`}
                    >
                      {destination.name}
                    </h3>
                    {destination.description ? (
                      <p className="mt-2 max-w-md text-body-sm text-blue-100/90">
                        {destination.description}
                      </p>
                    ) : null}
                      ...
                      <Link
                        ...
                        className={
                          destination.featured
                            ? "rounded-lg bg-white px-6 py-2.5 text-sm font-bold text-primary shadow-lg transition hover:bg-primary hover:text-white"
                            : "rounded-full border border-white/30 bg-white/10 p-2 text-white backdrop-blur transition hover:bg-white/20"
                        }
        ...
        <div className="container-shell">
          <Reveal className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-on-surface-variant">
              Browse our curated selection of top-rated tours designed for
              families, honeymooners, and adventurers.
            </p>
          </Reveal>
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium transition hover:-translate-y-0.5 ${
                  index === 0
                    ...
                    : "border border-outline-variant bg-white text-on-surface hover:border-primary"
                }`}
              >
              ...
              <Reveal key={travelPackage.title} delay={index * 90}>
                <article className="package-card group overflow-hidden rounded-2xl border border-outline-variant/30 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                  <div className="relative h-56 overflow-hidden">
                    ...
                    {travelPackage.badge ? (
                      <span
                        className={`absolute right-4 top-4 rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-white ${index === 2 ? "bg-tertiary" : "bg-secondary-container"}`}
                      >
                        {travelPackage.badge}
                      </span>
                    ) : null}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between border-t border-slate-100 pt-6">
                      ...
                      <Link
                        to="/contact"
                        className="rounded-lg bg-primary px-4 py-2 text-xs font-bold text-white transition hover:brightness-110"
                      >
                        Enquire Now
                      </Link>
                    </div>
        ...
        <div className="container-shell relative z-10 grid gap-12 lg:grid-cols-2 lg:items-start">
          <Reveal>
            <InquiryForm
              ...
              defaultService="Tour Packages"
              formType="packages"
            />
          </Reveal>
          <Reveal
            delay={120}
            className="rounded-3xl border border-primary/10 bg-primary/5 p-8"
          >
            ...
            <p className="italic leading-relaxed text-on-surface-variant">
              GK Immigrations organized our honeymoon trip to Thailand and it
              was flawless. High-conversion team indeed!
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-primary px-6 py-20 text-center text-white">
        <div className="absolute inset-0 opacity-10">
          <img
            src="https://images.unsplash.com/photo-1589519160732-576f165b9aad?auto=format&fit=crop&q=80&w=1800"
            alt=""
        ...
        <Reveal className="relative z-10 mx-auto max-w-3xl">
          <Sparkles
            className="mx-auto mb-4 text-secondary-fixed"
            size={34}
            aria-hidden="true"
          />
          ...
          <p className="mt-4 text-blue-100">
            Ready to explore? Connect with our experts today and get a
            personalized itinerary for your dream destination.
          </p>
          <div className="mt-10 flex flex-col justify-center gap-4 md:flex-row">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-10 py-4 font-heading font-bold text-white transition hover:-translate-y-0.5 hover:brightness-110"
            >
...
function SearchField({ label, value, icon: Icon, noDivider = false }) {
  return (
    <label
      className={`flex w-full flex-1 items-center gap-3 px-6 py-3 ${noDivider ? "" : "border-b border-slate-200 md:border-b-0 md:border-r"}`}
    >
