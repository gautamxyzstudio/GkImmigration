...
export function NotFoundPage() {
  return (
    <>
      <Seo
        title="Page Not Found | GK Immigrations"
        description="The requested GK Immigrations page could not be found."
      />
      <section className="container-shell grid min-h-[60vh] place-items-center py-20 text-center">
        <div className="max-w-xl">
          <p className="font-heading text-label-md uppercase tracking-widest text-secondary-container">
            404
          </p>
          ...
          <p className="mt-4 text-on-surface-variant">
            The link may be outdated, but the main travel and immigrations
            services are still ready for you.
          </p>
          <Link
            to="/"
